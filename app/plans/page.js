...
function App() {
  ...
  return (
    <div className="App" >
       <div id='header_holder' ><Header/>
       
       </div>
       <div id='baka'><h1>اختر الباقه المناسبه لك</h1></div>
       <div id='bakaPrice' ><h2>اسعار مناسبه لك</h2></div>
       <div id='bakaPrice1' ><h5>تجربه مجانيه 14 يوم على كل يوم</h5></div>
